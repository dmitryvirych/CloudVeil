...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self != nil)
    {
        ...
        bool compact = TGAppDelegateInstance.rootController.currentSizeClass == UIUserInterfaceSizeClassCompact;
        if (compact)
        {
        ...
        _stickerPacksDisposable = [[[SSignal combineSignals:@[[TGMaskStickersSignals stickerPacks], [TGStickersSignals stickerPacks], [TGRecentMaskStickersSignal recentStickers]]] deliverOn:[SQueue mainQueue]] startWithNext:^(NSArray *masksAndStickers)
        {
